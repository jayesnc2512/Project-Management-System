...
<body>
    <section  class="heading">
        ...
        <div class="student-details">
            ...
            <div class="row">
                <div class="col-md-2 col-4 student-roll">
                    ROLL NO. :-<?php echo $row['rollno_2'];?>
                </div>
                <div class="col-md-4 col-6 student-name">
                    STUDENT NAME:-<?php echo $row['name_2'];?>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 col-4 student-roll">
                    ROLL NO. :- <?php echo $row['rollno_3'];?>
                </div>
                <div class="col-md-4 col-6 student-name">
                    STUDENT NAME:-<?php echo $row['name_3'];?>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 col-4 student-roll">
                    ROLL NO. :-<?php echo $row['rollno_4'];?>
                </div>
                <div class="col-md-4 col-6 student-name">
                    STUDENT NAME:-<?php echo $row['name_4'];?>
                </div>
            </div>
            <div class="vl">
